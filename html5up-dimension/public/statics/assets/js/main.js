  ...
  firebase.auth().signInAnonymously()
    ...
    .then(function (snapshot) {
      ...
      if (data.facebook && data.facebook.link) {
        $('#social').append('<li><a href="' + data.facebook.link + '" class="icon fa-facebook"><span class="label">Facebook</span></a></li>')
      }

      if (data.github && data.github.link) {
        $('#social').append('<li><a href="' + data.github.link + '" class="icon fa-github"><span class="label">Github</span></a></li>')
      }

      if (data.instagram && data.instagram.link) {
        $('#social').append('<li><a href="' + data.instagram.link + '" class="icon fa-instagram"><span class="label">Instagram</span></a></li>')
      }

      if (data.twitter && data.twitter.link) {
        $('#social').append('<li><a href="' + data.twitter.link + '" class="icon fa-twitter"><span class="label">Twitter</span></a></li>')
      }
